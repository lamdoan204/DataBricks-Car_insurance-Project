...
\echo 'Bắt đầu dọn dẹp dữ liệu'
\echo "-----------------------------------"
TRUNCATE TABLE customers, policies, insurance_claims;
\echo 'Dọn dẹp dữ liệu cũ hoàn tất'
\echo "-----------------------------------"
